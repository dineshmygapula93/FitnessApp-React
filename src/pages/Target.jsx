  ...
  return (
    ...
    <div className='min-h-screen flex'>
      ...
      <div className='w-3/4 sm:w-3/4 bg-green-50'>
        <h1 className='text-4xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 my-8 drop-shadow-lg'>{target}</h1>
