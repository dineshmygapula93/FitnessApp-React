    ...
    <>
      <div className="h-full min-h-screen">
        <div className="flex h-14 my-2 justify-center items-center">
          <h1 className="text-5xl">Please Select Exercise Type you want</h1>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 px-5 justify-center h-full min-h-screen">
